...
def main():
    ...
    parser.add_argument(
        ...
        dest="wordlist",
        required=False,
        help="Set the wordlist to use for generated"
        " commands. Ex /usr/share/wordlist.txt")
    parser.add_argument(
        "--pingsweep",
        dest="ping_sweep",
        action="store_true",
    ...
    parser.add_argument(
        ...
        dest="hostname_scan",
        action="store_true",
        help="Attempt to discover target hostnames"
        " and write to 0-name.txt and hostnames.txt.",
        default=False)
    parser.add_argument(
        "--snmp",
    ...
    parser.add_argument(
        ...
        dest="follow",
        action="store_true",
        help="Execute shell comamnds from recommendations"
        " as they are discovered. "
        "Likely to lead to very long execute times"
        " depending on the wordlist being used.",
        default=False)
    parser.add_argument(
        "--simple_exec",
        dest="quickfollow",
        action="store_true",
        help="Execute non-brute forcing shell"
        " comamnds only as they are discovered.",
        default=False)
