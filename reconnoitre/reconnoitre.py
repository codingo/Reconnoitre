...
from virtual_host_scanning import virtual_hosts
...
def main():
    ...
    parser.add_argument("--virtualhosts",   dest="virtualhosts", action="store_true", help="Scan for virtual host networks using the asscoatied wordlist.", default=False)
    ...
    if arguments.virtualhosts is True:
        if arguments.wordlist is False:
            print("[#] Unable to scan for virtual hosts as no wordlist was provided.")
        else:
            vh = virtual_hosts()
