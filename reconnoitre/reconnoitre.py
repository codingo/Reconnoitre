...
def main():
    ...
    parser.add_argument("--quick", dest="quick", required=False, help="Move to the next target after performing a quick scan and writing first-round recommendations.")    
